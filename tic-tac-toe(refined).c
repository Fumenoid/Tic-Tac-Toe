...
int fumewb(int arr[][3], int k){
    for(int x=0;x<3;x++) {
    if((arr[x][0]==arr[x][1])&&(arr[x][0]==k)) {
        if(arr[x][2]==32){
         arr[x][2]=79;
         return 1;
        }
    }
    if((arr[x][0]==arr[x][2])&&(arr[x][0]==k)) {
        if(arr[x][1]==32){
         arr[x][1]=79;
         return 1;
        }
    }
    if((arr[x][1]==arr[x][2])&&(arr[x][1]==k)) {
        if(arr[x][0]==32){
         arr[x][0]=79;
         return 1;
        }
    ...
    for(int y=0;y<3;y++) {
    if((arr[0][y]==arr[1][y])&&(arr[0][y]==k)) {
        if(arr[2][y]==32){
         arr[2][y]=79;
         return 1;
        }
    }
    if((arr[0][y]==arr[2][y])&&(arr[0][y]==k)) {
        if(arr[1][y]==32){
         arr[1][y]=79;
         return 1;
        }
    }
    if((arr[1][y]==arr[2][y])&&(arr[1][y]==k)) {
        if(arr[0][y]==32){
         arr[0][y]=79;
         return 1;
        }
    ...
    if((arr[0][0]==arr[1][1])&&(arr[0][0]==k)) {
        if(arr[2][2]==32){
         arr[2][2]=79;
         return 1;
        }
    }
    else if((arr[0][0]==arr[2][2])&&(arr[0][0]==k)) {
        if(arr[1][1]==32){
         arr[1][1]=79;
         return 1;
        }
    }
    else if((arr[1][1]==arr[2][2])&&(arr[1][1]==k)) {
        if(arr[0][0]==32){
         arr[0][0]=79;
         return 1;
        }
    }
    else if((arr[2][0]==arr[1][1])&&(arr[2][0]==k)) {  
        if(arr[0][2]==32){
         arr[0][2]=79;
         return 1;
        }
    }
    else if((arr[2][0]==arr[0][2])&&(arr[2][0]==k)) {  
        if(arr[1][1]==32){
         arr[1][1]=79;
         return 1;
        }
    }
    else if((arr[1][1]==arr[0][2])&&(arr[1][1]==k)) {  
        if(arr[0][2]==32){
         arr[0][2]=79;
         return 1;
        }
...
int main() {
    ...
    if(mode=='s'||mode=='S') {
        int turn=(rand()%2)+1;
        if(turn==1){
        printf("Its Player's turn First :)\n");
        sleep(1);
        while(itsgame!=1) {
        player(arr, 0, 0);
        itsgame=check(arr, 0);
        ...
        printf("Its Computer's turn First :)\n");
        sleep(1);
        while(itsgame!=1) {
        fumesai(arr);
        itsgame=check(arr, 0);
